...
class MashupInfo {
  ...
  MashupInfo({this.canToggleMashupsAllowed, this.formattedMashupsCount, this.hasBeenMashedUp, this.hasNonmimicableAdditionalAudio, this.isCreatorRequestingMashup, this.isLightWeightCheck, this.isLightWeightReuseAllowedCheck, this.isPivotPageAvailable, this.isReuseAllowed, this.mashupType, this.mashupsAllowed, this.nonPrivacyFilteredMashupsMediaCount, this.originalMedia, this.privacyFilteredMashupsMediaCount});
  ...
  MashupInfo.fromJson(Map<String, dynamic> json) {
    ...
    if(json["is_light_weight_reuse_allowed_check"] is bool) {
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["is_light_weight_reuse_allowed_check"] = isLightWeightReuseAllowedCheck;
  ...
  MashupInfo copyWith({
    ...
    isLightWeightReuseAllowedCheck: isLightWeightReuseAllowedCheck ?? this.isLightWeightReuseAllowedCheck,
